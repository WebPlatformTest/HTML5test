var UserAgents = (function(){
	...
	var WINDOWS_PHONE_MODELS = {
		...
		'NOKIA': {
			...
			'Nokia 800C':							[ 'Nokia', 'Lumia 800' ],
			'Nokia 800':							[ 'Nokia', 'Lumia 800' ],
	...
	var ANDROID_MODELS = {
		...
		'mt6575 phone':								[ 'Mediatek', 'MT6575' + STRINGS_BASED ],		
		...
		'msm8625':									[ STRINGS_QUALCOMM, 'Snapdragon S4' + STRINGS_BASED ],
		...
		'A211':										[ STRINGS_ACER, 'Iconia Tab A211', 'tablet' ],
		...
		'P2A700':									[ STRINGS_ACER, 'Iconia Tab A700', 'tablet' ],
		'A701':										[ STRINGS_ACER, 'Iconia Tab A701', 'tablet' ],
		...
		'Novo7 Fire':								[ 'Ainovo', 'Novo7 Fire', 'tablet' ],
		...
		'A70H':										[ STRINGS_ARCHOS, '7 Home Tablet', 'tablet' ],					// G7
		'A70HB':									[ STRINGS_ARCHOS, '7 Home Tablet', 'tablet' ],
		'A70BHT':									[ STRINGS_ARCHOS, '7 Home Tablet', 'tablet' ],
		'A70CHT':									[ STRINGS_ARCHOS, '7 Home Tablet', 'tablet' ],
		'A70S':										[ STRINGS_ARCHOS, '70 Internet Tablet', 'tablet' ],				// G8
		'A7EB':										[ STRINGS_ARCHOS, '70B Internet Tablet', 'tablet' ],
		'ARCHOS 70it2':								[ STRINGS_ARCHOS, '70B Internet Tablet', 'tablet' ],		
		'A101IT':									[ STRINGS_ARCHOS, '101 Internet Tablet', 'tablet' ],		
		'ARCHOS 80G9':								[ STRINGS_ARCHOS, '80 G9', 'tablet' ],							// G9
		'ARCHOS 101G9':								[ STRINGS_ARCHOS, '101 G9', 'tablet' ],						
		'ARCHOS 97XSLG10':							[ STRINGS_ARCHOS, '97 XS', 'tablet' ],							// G10
		'ARCHOS 101G10':							[ STRINGS_ARCHOS, '101 XS', 'tablet' ],
		'ARCHOS 97 CARBON':							[ STRINGS_ARCHOS, '97 Carbon', 'tablet' ],						// Elements
		...
		'Transformer Pad TF700T':					[ STRINGS_ASUS, 'Transformer Pad Infinity 700', 'tablet' ],
		...
		'ASUS Transformer Pad TF300TL':				[ STRINGS_ASUS, 'Transformer Pad 300', 'tablet' ],
		...
		'MID7035':									[ 'Coby', 'Kyros MID7035', 'tablet' ],
		...
		'Coolpad 7260A':							[ STRINGS_COOLPAD, '7260' ],
		...
		'Google Nexus 7':							[ 'Google', 'Nexus 7', 'tablet' ],
		...
		'HTC ChaCha A810':							[ STRINGS_HTC, 'ChaCha' ],
		...
		'HTC EVO Design 4G':						[ STRINGS_HTC, 'EVO Design 4G' ],
		'HTCEVODesign4G':							[ STRINGS_HTC, 'EVO Design 4G' ],
		...
		'MediaPad 7 Lite':							[ STRINGS_HUAWEI, 'MediaPad 7 Lite', 'tablet' ],
		'MediaPad 10 FHD':							[ STRINGS_HUAWEI, 'MediaPad 10', 'tablet' ],
		...
		'U9200E':									[ STRINGS_HUAWEI, 'Ascend P1' ],
		...
		'Micromax A90':								[ 'Micromax', 'A90 Superfone' ],
		...
		'Rikomagic MK802':							[ 'Rikomagic', 'MK802', 'television' ],
		...
		'GT-I9305T':								[ STRINGS_SAMSUNG, STRINGS_GALAXY + ' S III' ],
		...
		'GT-S5360T':								[ STRINGS_SAMSUNG, STRINGS_GALAXY + ' Y' ],
		...
		'SHW-M340K':								[ STRINGS_SAMSUNG, STRINGS_GALAXY + ' M Style' ],
		...
		'SPH-D710BST':								[ STRINGS_SAMSUNG, 'Epic 4G Touch' ],
		...
		'LT18':										[ STRINGS_SONY_ERICSSON, STRINGS_XPERIA + ' Arc S' ],
		...
		'SonyLT30a':								[ 'Sony', STRINGS_XPERIA + ' T' ],
		'SonyLT30p':								[ 'Sony', STRINGS_XPERIA + ' T' ],
		'LT30p':									[ 'Sony', STRINGS_XPERIA + ' T' ],
		...
		'SonyST21a2':								[ 'Sony', STRINGS_XPERIA + ' Tipo Dual' ],
		'SonyST21i2':								[ 'Sony', STRINGS_XPERIA + ' Tipo Dual' ],
		'SonyST23i':								[ 'Sony', STRINGS_XPERIA + ' Miro' ],
		'ST23i':									[ 'Sony', STRINGS_XPERIA + ' Miro' ],
		'ST25i':									[ 'Sony', STRINGS_XPERIA + ' U' ],
		'SonyST26i':								[ 'Sony', STRINGS_XPERIA + ' J' ],
		...
		'SonySO-05D':								[ 'Sony', STRINGS_XPERIA + ' SX' ],
		...
		'Teclast P85':								[ 'Teclast', 'P85', 'tablet' ],
		...
		'N90 DUAL CORE2':							[ 'Window', 'N90 Dual Core', 'tablet' ],
