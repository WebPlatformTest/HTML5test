var UserAgents = (function(){
	...
	var DeviceModels = (function(){
		...
		var ANDROID_MODELS = {
			...
			'WFJW[IA]!':								[ 'Amazon', 'Kindle Fire HD 8.9"', TYPE_TABLET ],
			...
			'Dooderbutt!':								[ 'Google', 'Nexus S' ],
			'(Google )?Nexus 7!':						[ 'Google', 'Nexus 7', TYPE_TABLET ],
			...
			'HTC .*A510(b|c|e)!':						[ STRINGS_HTC, 'Wildfire S' ],
			...
			'HTC DLX U':								[ STRINGS_HTC, 'One X5' ],
			'HTC6435LVW 4G':							[ STRINGS_HTC, 'One X5' ],
			...
			'Huawei U9510E':							[ STRINGS_HUAWEI, 'Ascend D quad' ],
			...
			'IdeaTab ?A2107(A-H)!':						[ STRINGS_LENOVO, 'IdeaTab V2107A', TYPE_TABLET ],
			...
			'SCH-i705 4G':								[ STRINGS_SAMSUNG, STRINGS_GALAXY + ' Tab 2 (7.0)', TYPE_TABLET ],
			...
			'SGH-I317M':								[ STRINGS_SAMSUNG, STRINGS_GALAXY + ' Note II' ],
			...
			'LT29i!':									[ STRINGS_SONY, STRINGS_XPERIA + ' GX' ],
			...
			'Blade(-V880|-opda)?$!':					[ STRINGS_ZTE, 'Blade' ],
		...
		var WINDOWS_PHONE_MODELS = {
			...
			'OM(NI|IN)A7!':								[ STRINGS_SAMSUNG, 'Omnia 7' ],
